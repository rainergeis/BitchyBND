...
internal static class WBXF3
{
    ...
    public static void Repack(string sourceDir, string targetDir)
    {
        ...
        var bhdFilename = xml.SelectSingleNode("bxf3/bhd_filename").InnerText;
        var bdtFilename = xml.SelectSingleNode("bxf3/bdt_filename").InnerText;
        var root = xml.SelectSingleNode("bxf3/root")?.InnerText ?? "";
