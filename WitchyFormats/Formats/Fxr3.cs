...
public class Fxr3 : SoulsFile<Fxr3>
{
    ...
    protected override void Read(BinaryReaderEx br)
    {
        ...
        br.AssertInt32(1);
        Id = br.ReadInt32();
        var stateMachineOffset = br.ReadInt32();
        ...
        var containerOffset = br.ReadInt32();
        ...
        {
            var section12Offset = br.ReadInt32();
            var section12Count = br.ReadInt32();
            var section13Offset = br.ReadInt32();
            var section13Count = br.ReadInt32();
            var section14Offset = br.ReadInt32();
            var section14Count = br.ReadInt32();
            var section15Offset = br.ReadInt32();
            var section15Count = br.ReadInt32();
    ...
    protected override void Write(BinaryWriterEx bw)
    {
        ...
        var transitions = new List<FFXTransition>();
        ...
        var Containers = new List<FFXContainer>();
        ...
        EffectCount = 0;
        var actions = new List<FFXAction>();
        for (var index = 0; index < Containers.Count; ++index)
        ...
        var properties = new List<FFXProperty>();
        ...
        var conditionalProperties = new List<FFXProperty>();
        ...
        for (var index = 0; index < conditionalProperties.Count; ++index)
            conditionalProperties[index].WriteFields(bw, index, ref fieldCount, true);
        for (var index = 0; index < section10s.Count; ++index)
    ...
    public class FFXStateMachine
    {
        ...
        public FFXStateMachine()
        {
            States = new List<FFXState>();
        }
    ...
    public class FFXState
    {
        ...
        public FFXState()
        {
            Transitions = new List<FFXTransition>();
        }
    ...
    public class FFXTransition
    {
        ...
        {
            var count = ffxTransitions.Count;
            bw.WriteInt16(Unk00);
            bw.WriteByte(0);
            bw.WriteByte(1);
            bw.WriteInt32(0);
    ...
    public class FFXContainer
    {
        ...
        internal FFXContainer(BinaryReaderEx br)
        {
            ...
            br.AssertInt32(0);
            var EffectCount = br.ReadInt32();
            var ActionCount = br.ReadInt32();
            var ContainerCount = br.ReadInt32();
            br.AssertInt32(0);
            var EffectOffset = br.ReadInt32();
            br.AssertInt32(0);
            var ActionOffset = br.ReadInt32();
            br.AssertInt32(0);
            var ContainerOffset = br.ReadInt32();
            br.AssertInt32(0);
        ...
        {
            var num = containers.IndexOf(this);
        ...
        internal void WriteEffects(BinaryWriterEx bw, int index, ref int effectCount)
        {
            ...
            else
            {
                ...
                for (var index1 = 0; index1 < Effects.Count; ++index1)
    ...
    public class FFXAction
    {
        ...
        internal FFXAction(BinaryReaderEx br)
        {
            ...
            var fieldCount1 = br.ReadInt32(); // 8
            var section10Count = br.ReadInt32(); // 12
            var propertyCount1 = br.ReadInt32(); // 16
            var fieldCount2 = br.ReadInt32(); // 20
            br.AssertInt32(0);
            var propertyCount2 = br.ReadInt32();
            var fieldOffset = br.ReadInt32();
            // Console.WriteLine($"fieldOffset: {fieldOffset}");
            br.AssertInt32(0);
            var section10Offset = br.ReadInt32();
            br.AssertInt32(0);
            var propertyOffset = br.ReadInt32();
            br.AssertInt32(0);
            br.AssertInt32(0);
            br.AssertInt32(0);
            ...
            br.StepIn(section10Offset);
            {
                ...
                for (var index = 0; index < section10Count; ++index)
    ...
    public abstract class FFXField
    {
        ...
        {
            if (field.GetType() == typeof(FFXFieldFloat)) return new FFXFieldFloat(((FFXFieldFloat)field).Value);

            if (field.GetType() == typeof(FFXFieldInt)) return new FFXFieldInt(((FFXFieldInt)field).Value);
        ...
        public static FFXField Read(BinaryReaderEx br, object? context = null, int? index = null)
        {
            ...
            else if (context is FFXTransition transition)
            {
                if (transition.TargetStateIndex == -1)
                    ffxField = index == 0
                        ? new FFXFieldFloat(br.GetSingle(br.Position))
                        : new FFXFieldInt(br.GetInt32(br.Position));
                else
                    ffxField = index == 1
                        ? new FFXFieldFloat(br.GetSingle(br.Position))
                        : new FFXFieldInt(br.GetInt32(br.Position));
            ...
            else
            {
                ...
                var single = br.GetSingle(br.Position);
        ...
        {
            var ffxFieldList = new List<FFXField>();
    ...
    public class FFXProperty
    {
        ...
        internal void Write(BinaryWriterEx bw, List<FFXProperty> properties, bool conditional)
        {
            ...
            var typeEnumA = (int)PropertyType | ((int)InterpolationType << 4) | (Convert.ToInt32(IsLoop) << 12);
            var typeEnumB = ((int)PropertyType | ((int)InterpolationType << 2)) + (Convert.ToInt32(IsLoop) << 4);
