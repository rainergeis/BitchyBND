...
public partial class MSBE
{
    ...
    public class PartsParam : Param<Part>, IMsbParam<IMsbPart>
    {
        ...
        IMsbPart IMsbParam<IMsbPart>.Add(IMsbPart item)
        {
            return Add((Part)item);
        }
    ...
    public abstract class Part : Entry, IMsbPart
    {
        ...
        private protected Part(BinaryReaderEx br)
        {
            ...
            br.AssertInt32(0);
            var unkOffset1 = br.ReadInt64();
            var unkOffset2 = br.ReadInt64();
            var entityDataOffset = br.ReadInt64();
            var typeDataOffset = br.ReadInt64();
            var gparamOffset = br.ReadInt64();
            var sceneGParamOffset = br.ReadInt64();
            var unkOffset7 = br.ReadInt64();
            var unkOffset8 = br.ReadInt64();
            var unkOffset9 = br.ReadInt64();
            var unkOffset10 = br.ReadInt64();
            var unkOffset11 = br.ReadInt64();
            br.AssertInt64(0);
            br.AssertInt64(0);
            br.AssertInt64(0);
        ...
        public class UnkStruct1
        {
            ...
            ///     Unknown.
            /// </summary>
            public uint[] DisplayGroups { get; }

            /// <summary>
            ///     Unknown.
            /// </summary>
            public uint[] DrawGroups { get; }
        ...
        public class MapPiece : Part
        {
            ...
            private protected override void WriteUnk1(BinaryWriterEx bw)
            {
                Unk1.Write(bw);
            }
            ...
            private protected override void WriteUnk7(BinaryWriterEx bw)
            {
                Unk7.Write(bw);
            }

            private protected override void WriteUnk8(BinaryWriterEx bw)
            {
                Unk8.Write(bw);
            }

            private protected override void WriteUnk9(BinaryWriterEx bw)
            {
                Unk9.Write(bw);
            }

            private protected override void WriteUnk10(BinaryWriterEx bw)
            {
                Unk10.Write(bw);
            }

            private protected override void WriteUnk11(BinaryWriterEx bw)
            {
                Unk11.Write(bw);
            }
        }
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
            ...
            private protected override void WriteUnk2(BinaryWriterEx bw)
            {
                Unk2.Write(bw);
            }
