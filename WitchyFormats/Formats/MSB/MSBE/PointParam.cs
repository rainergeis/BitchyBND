...
public partial class MSBE
{
        ...
        public Region Add(Region region)
        {
            switch (region)
            {
                ...
                case Region.Connection r:
                    Connections.Add(r);
                    break;
                case Region.PatrolRoute22 r:
                    PatrolRoute22s.Add(r);
                    break;
                ...
                case Region.MufflingPortal r:
                    ...
                    break;
                case Region.SoundRegion r:
                    SoundRegions.Add(r);
                    break;
                case Region.MufflingPlane r:
                    MufflingPlanes.Add(r);
                    break;
                case Region.PatrolRoute r:
                    PatrolRoutes.Add(r);
                    break;
                case Region.MapPoint r:
                    MapPoints.Add(r);
                    break;
                case Region.WeatherOverride r:
                    WeatherOverrides.Add(r);
                    break;
                case Region.AutoDrawGroupPoint r:
                    AutoDrawGroupPoints.Add(r);
                    break;
                case Region.GroupDefeatReward r:
                    GroupDefeatRewards.Add(r);
                    break;
                case Region.MapPointDiscoveryOverride r:
                    MapPointDiscoveryOverrides.Add(r);
                    break;
                case Region.MapPointParticipationOverride r:
                    MapPointParticipationOverrides.Add(r);
                    break;
                case Region.Hitset r:
                    Hitsets.Add(r);
                    break;
                case Region.FastTravelRestriction r:
                    FastTravelRestriction.Add(r);
                    break;
                case Region.WeatherCreateAssetPoint r:
                    WeatherCreateAssetPoints.Add(r);
                    break;
                case Region.PlayArea r:
                    PlayAreas.Add(r);
                    break;
                case Region.EnvironmentMapOutput r:
                    EnvironmentMapOutputs.Add(r);
                    break;
                case Region.MountJump r:
                    MountJumps.Add(r);
                    break;
                case Region.Dummy r:
                    Dummies.Add(r);
                    break;
                case Region.FallPreventionRemoval r:
                    FallPreventionRemovals.Add(r);
                    break;
                case Region.NavmeshCutting r:
                    NavmeshCuttings.Add(r);
                    break;
                case Region.MapNameOverride r:
                    MapNameOverrides.Add(r);
                    break;
                case Region.MountJumpFall r:
                    MountJumpFalls.Add(r);
                    break;
                case Region.HorseRideOverride r:
                    HorseRideOverrides.Add(r);
                    break;
                case Region.Other r:
                    Others.Add(r);
                    break;
    ...
    public abstract class Region : Entry, IMsbRegion
    {
        ...
        private protected Region(BinaryReaderEx br)
        {
            ...
            Unk2C = br.ReadInt32();
            var baseDataOffset1 = br.ReadInt64();
            var baseDataOffset2 = br.ReadInt64();
            Unk40 = br.ReadInt32();
            MapStudioLayer = br.ReadUInt32();
            var shapeDataOffset = br.ReadInt64();
            var baseDataOffset3 = br.ReadInt64();
            var typeDataOffset = br.ReadInt64();
            var unkOffset4 = br.ReadInt64();
        ...
        internal override void Write(BinaryWriterEx bw, int id)
        {
            ...
            if (Type > RegionType.BuddySummonPoint && Type != RegionType.Other) bw.Pad(8);
