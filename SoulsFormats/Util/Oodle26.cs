...
internal static class Oodle26
{
    ...
    {
        var pOptions = OodleLZ_CompressOptions_GetDefault(compressor, level);
        ...
        try
        {
            ...
            var compressedBufferSizeNeeded = OodleLZ_GetCompressedBufferSizeNeeded(source.LongLength);
            var compBuf = new byte[compressedBufferSizeNeeded];
            var compLen = OodleLZ_Compress(compressor, source, source.LongLength, compBuf, level, pOptions, IntPtr.Zero,
    ...
    {
        var decodeBufferSize = OodleLZ_GetDecodeBufferSize(uncompressedSize, true);
        var rawBuf = new byte[decodeBufferSize];
        var rawLen = OodleLZ_Decompress(source, source.LongLength, rawBuf, uncompressedSize);
    ...
    private static extern long OodleLZ_Compress(
        ...
        [MarshalAs(UnmanagedType.LPArray)] byte[] rawBuf,
        long rawLen,
        [MarshalAs(UnmanagedType.LPArray)] byte[] compBuf,
    ...
    private static long OodleLZ_Compress(OodleLZ_Compressor compressor, byte[] rawBuf, long rawLen, byte[] compBuf,
        OodleLZ_CompressionLevel level)
    {
        return OodleLZ_Compress(compressor, rawBuf, rawLen, compBuf, level,
    ...
    {
        return OodleLZ_CompressOptions_GetDefault(OodleLZ_Compressor.OodleLZ_Compressor_Invalid,
            OodleLZ_CompressionLevel.OodleLZ_CompressionLevel_Normal);
    }
    ...
    {
        return OodleLZ_Decompress(compBuf, compBufSize, rawBuf, rawLen,
            OodleLZ_FuzzSafe.OodleLZ_FuzzSafe_Yes, OodleLZ_CheckCRC.OodleLZ_CheckCRC_No,
            OodleLZ_Verbosity.OodleLZ_Verbosity_None,
            IntPtr.Zero, 0, IntPtr.Zero, IntPtr.Zero, IntPtr.Zero, 0,
    ...
    {
        public readonly uint verbosity;
        public readonly int minMatchLen;
        [MarshalAs(UnmanagedType.Bool)] public bool seekChunkReset;
        public int seekChunkLen;
        public readonly OodleLZ_Profile profile;
        public readonly int dictionarySize;
        public readonly int spaceSpeedTradeoffBytes;
        public readonly int maxHuffmansPerChunk;
        [MarshalAs(UnmanagedType.Bool)] public readonly bool sendQuantumCRCs;
        public readonly int maxLocalDictionarySize;
        public readonly int makeLongRangeMatcher;
        public readonly int matchTableSizeLog2;
    }
