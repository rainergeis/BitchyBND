...
public partial class PARAM : SoulsFile<PARAM>
{
    ...
    protected override void Read(BinaryReaderEx br)
    {
        ...
        var copy = br.GetBytes(0, (int)br.Stream.Length);
        ...
        {
            br.AssertInt32(0);
            var paramTypeOffset = br.ReadInt64();
    ...
    /// <summary>
    ///     Applies the first paramdef in the sequence whose param type, data version, and row size match this param's, if any.
