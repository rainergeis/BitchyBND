...
public partial class PARAM
{
    ...
    public class Enum : List<Enum.Item>
    {
        ...
        internal Enum(XmlNode node)
        {
            ...
            {
                var itemName = itemNode.Attributes["name"].InnerText;
                var itemValue = Layout.ParseParamValue(Type, itemNode.Attributes["value"].InnerText);
        ...
        public PARAMTDF ToParamtdf(string name)
        {
            ...
            switch (Type)
            {
                case CellType.u8:
                case CellType.x8:
                    tdfType = PARAMDEF.DefType.u8;
                    break;
                case CellType.s8:
                    tdfType = PARAMDEF.DefType.s8;
                    break;
                case CellType.u16:
                case CellType.x16:
                    tdfType = PARAMDEF.DefType.u16;
                    break;
                case CellType.s16:
                    tdfType = PARAMDEF.DefType.s16;
                    break;
                case CellType.u32:
                case CellType.x32:
                    tdfType = PARAMDEF.DefType.u32;
                    break;
                case CellType.s32:
                    tdfType = PARAMDEF.DefType.s32;
                    break;
            ...
            foreach (Item item in this) tdf.Entries.Add(new PARAMTDF.Entry(item.Name, item.Value));
            return tdf;
        }
