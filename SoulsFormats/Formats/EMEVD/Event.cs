...
public partial class EMEVD
{
    ...
    public class Event
    {
        ...
        {
            ID = br.ReadVarint();
            var instructionCount = br.ReadVarint();
            var instructionsOffset = br.ReadVarint();
            var parameterCount = br.ReadVarint();
            var parametersOffset = br.ReadVarint();
        ...
        {
            var instrsOffset = Instructions.Count > 0 ? bw.Position - offsets.Instructions : -1;
        ...
        {
            var paramsOffset = Parameters.Count > 0 ? bw.Position - offsets.Parameters : -1;
