...
{
    /// <summary>
    ///     An instruction given to the game which tells it to subsitute arg bytes in a particular instruction with ones
    ///     defined here.
    /// </summary>
    public class Parameter
    {
        ...
        /// <summary>
        ///     Unknown; always 0 before Sekiro, generally counts up from 1 for each parameter in an event. Does not seem to have
        ///     any effect in-game.
        /// </summary>
