...
public partial class DRB
{
    ...
    public class Dlg : Dlgo
    {
        ...
        internal Dlg(BinaryReaderEx br, Dictionary<int, string> strings, Dictionary<int, Shape> shapes,
            Dictionary<int, Control> controls, Dictionary<int, Dlgo> dlgos) : base(br, strings, shapes, controls)
        {
            var dlgoCount = br.ReadInt32();
            var dlgoOffset = br.ReadInt32();
            ...
            for (var i = 0; i < dlgoCount; i++)
            {
                var offset = dlgoOffset + DLGO_SIZE * i;
        ...
        internal void Write(BinaryWriterEx bw, Dictionary<string, int> stringOffsets, Queue<int> shapOffsets,
