...
public partial class DRB
{
    ...
    public abstract class Shape
    {
        ...
        internal static Shape Read(BinaryReaderEx br, DRBVersion version, Dictionary<int, string> strings,
            long shprStart)
        {
            var typeOffset = br.ReadInt32();
            var shprOffset = br.ReadInt32();
        ...
        public abstract class TextBase : Shape
        {
            ...
            internal TextBase(BinaryReaderEx br, DRBVersion version, Dictionary<int, string> strings) : base(br,
                version)
            {
                BlendMode = br.ReadEnum8<BlendingMode>();
                var unk01 = br.ReadBoolean();
        ...
        public class ScrollText : TextBase
        {
            ...
            internal ScrollText(BinaryReaderEx br, DRBVersion version, Dictionary<int, string> strings) : base(br,
                version, strings)
            {
            }
        ...
        public class Text : TextBase
        {
            ...
            internal Text(BinaryReaderEx br, DRBVersion version, Dictionary<int, string> strings) : base(br, version,
                strings)
            {
            }
