...
public partial class DRB
{
    ...
    public class Dlgo
    {
        ...
        internal Dlgo(BinaryReaderEx br, Dictionary<int, string> strings, Dictionary<int, Shape> shapes,
            Dictionary<int, Control> controls)
        {
            var nameOffset = br.ReadInt32();
            var shapOffset = br.ReadInt32();
            var ctrlOffset = br.ReadInt32();
            Unk0C = br.ReadInt32();
            Unk10 = br.ReadInt32();
            Unk14 = br.ReadInt32();
            Unk18 = br.ReadInt32();
