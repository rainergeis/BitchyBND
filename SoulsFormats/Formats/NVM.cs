...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
    ...
    protected override void Read(BinaryReaderEx br)
    {
        ...
        var rootBoxOffset = br.ReadInt32();
        br.AssertInt32(0);
        var entityCount = br.ReadInt32();
        var entityOffset = br.ReadInt32();
        for (var i = 0; i < 23; i++)
            br.AssertInt32(0);
    ...
    protected override void Write(BinaryWriterEx bw)
    {
        ...
        var rootBoxOffset = RootBox.Write(bw, boxTriangleIndexOffsets);
    ...
    public class Triangle
    {
        ...
        internal Triangle(BinaryReaderEx br)
        {
            ...
            var obstaclesAndFlags = br.ReadInt32();
        ...
        internal void Write(BinaryWriterEx bw)
        {
            ...
            var obstaclesAndFlags = (ObstacleCount << 2) | ((int)Flags << 16);
        ...
        {
            return
                $"[{VertexIndex1}, {VertexIndex2}, {VertexIndex3}] [{EdgeIndex1}, {EdgeIndex2}, {EdgeIndex3}] {Flags} {ObstacleCount}";
        }
    }
    ...
    public class Box
    {
        ...
        internal Box(BinaryReaderEx br)
        {
            ...
            var triangleOffset = br.ReadInt32();
            var boxOffset1 = br.ReadInt32();
            var boxOffset2 = br.ReadInt32();
            var boxOffset3 = br.ReadInt32();
            var boxOffset4 = br.ReadInt32();
            br.AssertInt32(0);
            br.AssertInt32(0);
            br.AssertInt32(0);
            br.AssertInt32(0);
        ...
        {
            var boxOffset1 = ChildBox1?.Write(bw, triangleIndexOffsets) ?? 0;
            var boxOffset2 = ChildBox2?.Write(bw, triangleIndexOffsets) ?? 0;
            var boxOffset3 = ChildBox3?.Write(bw, triangleIndexOffsets) ?? 0;
            var boxOffset4 = ChildBox4?.Write(bw, triangleIndexOffsets) ?? 0;

            var thisOffset = (int)bw.Position;
