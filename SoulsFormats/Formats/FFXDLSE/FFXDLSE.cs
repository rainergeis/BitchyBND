...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    ...
    protected override void Read(BinaryReaderEx br)
    {
        ...
        br.AssertByte(0);
        br.AssertInt32(1);
        var classNameCount = br.ReadInt16();
    ...
    private static XmlSerializer MakeSerializers(int returnIndex)
    {
        XmlSerializer[] serializers = XmlSerializer.FromTypes(
            new[] { typeof(FFXDLSE), typeof(State), typeof(Param) });
    ...
    {
        return (FFXDLSE)FFXSerializer.Deserialize(stream);
    }

    public static FFXDLSE XmlDeserialize(TextReader textReader)
    {
        return (FFXDLSE)FFXSerializer.Deserialize(textReader);
    }

    public static FFXDLSE XmlDeserialize(XmlReader xmlReader)
    {
        return (FFXDLSE)FFXSerializer.Deserialize(xmlReader);
    }
