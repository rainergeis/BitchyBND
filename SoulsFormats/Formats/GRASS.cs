...
public class GRASS : SoulsFile<GRASS>
{
    ...
    protected override bool Is(BinaryReaderEx br)
    {
        ...
        var version = br.GetInt32(0);
        var headerSize = br.GetInt32(4);
        var volumeSize = br.GetInt32(8);
        var vertexSize = br.GetInt32(0x10);
        var faceSize = br.GetInt32(0x18);
        var boundingBoxSize = br.GetInt32(0x20);
    ...
    public class Vertex
    {
        ...
        /// </summary>
        public float[] GrassDensities { get; }
