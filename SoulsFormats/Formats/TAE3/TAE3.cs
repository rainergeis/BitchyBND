...
public partial class TAE3 : SoulsFile<TAE3>
{
    ...
    protected override void Read(BinaryReaderEx br)
    {
        ...
        br.AssertByte(0);
        br.AssertByte(0xFF);
        var version = br.AssertInt32(0x1000C);
        ...
        br.AssertInt64(0);
        br.AssertInt64(0xB0);
        var skeletonNameOffset = br.ReadInt64();
        var sibNameOffset = br.ReadInt64();
        br.AssertInt64(0);
        br.AssertInt64(0);
    ...
    public class Animation
    {
        ...
        internal Animation(BinaryReaderEx br)
        {
            ...
            br.StepIn(offset);
            {
                var eventHeadersOffset = br.ReadInt64();
                var eventGroupsOffset = br.ReadInt64();
                br.ReadInt64(); // Times offset
                var animFileOffset = br.ReadInt64();
                var eventCount = br.ReadInt32();
                var eventGroupCount = br.ReadInt32();
                ...
                {
                    for (var i = 0; i < eventGroupCount; i++)
                ...
                br.StepIn(animFileOffset);
                {
                    ...
                    var animFileNameOffset = br.ReadInt64();
        ...
        internal void WriteEventGroupHeaders(BinaryWriterEx bw, int i)
        {
            if (EventGroups.Count > 0)
            {
                ...
                for (var j = 0; j < EventGroups.Count; j++)
    ...
    public class EventGroup
    {
        ...
        {
            var entryCount = br.ReadInt64();
            var valuesOffset = br.ReadInt64();
            var typeOffset = br.ReadInt64();
            br.AssertInt64(0);
            ...
            {
                Indices = br.ReadInt32s((int)entryCount)
                    .Select(offset => eventHeaderOffsets.FindIndex(headerOffset => headerOffset == offset)).ToList();
            }
            br.StepOut();
        }
