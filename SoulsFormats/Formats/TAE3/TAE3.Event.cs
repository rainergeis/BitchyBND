...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
    ...
    public abstract class Event
    {
        ...
        {
            var startTimeOffset = br.ReadInt64();
            var endTimeOffset = br.ReadInt64();
            var eventDataOffset = br.ReadInt64();
            var startTime = br.GetSingle(startTimeOffset);
            var endTime = br.GetSingle(endTimeOffset);
            ...
            br.StepIn(eventDataOffset);
            {
                ...
                switch (type)
                {
                    case EventType.JumpTable:
                        result = new JumpTable(startTime, endTime, br);
                        break;
                    case EventType.Unk001:
                        result = new Unk001(startTime, endTime, br);
                        break;
                    case EventType.Unk002:
                        result = new Unk002(startTime, endTime, br);
                        break;
                    case EventType.Unk005:
                        result = new Unk005(startTime, endTime, br);
                        break;
                    case EventType.Unk016:
                        result = new Unk016(startTime, endTime, br);
                        break;
                    case EventType.Unk017:
                        result = new Unk017(startTime, endTime, br);
                        break;
                    case EventType.Unk024:
                        result = new Unk024(startTime, endTime, br);
                        break;
                    case EventType.SwitchWeapon1:
                        result = new SwitchWeapon1(startTime, endTime, br);
                        break;
                    case EventType.SwitchWeapon2:
                        result = new SwitchWeapon2(startTime, endTime, br);
                        break;
                    case EventType.Unk034:
                        result = new Unk034(startTime, endTime, br);
                        break;
                    case EventType.Unk035:
                        result = new Unk035(startTime, endTime, br);
                        break;
                    case EventType.Unk064:
                        result = new Unk064(startTime, endTime, br);
                        break;
                    case EventType.Unk065:
                        result = new Unk065(startTime, endTime, br);
                        break;
                    case EventType.CreateSpEffect1:
                        result = new CreateSpEffect1(startTime, endTime, br);
                        break;
                    case EventType.CreateSpEffect2:
                        result = new CreateSpEffect2(startTime, endTime, br);
                        break;
                    case EventType.PlayFFX:
                        result = new PlayFFX(startTime, endTime, br);
                        break;
                    case EventType.Unk110:
                        result = new Unk110(startTime, endTime, br);
                        break;
                    case EventType.HitEffect:
                        result = new HitEffect(startTime, endTime, br);
                        break;
                    case EventType.Unk113:
                        result = new Unk113(startTime, endTime, br);
                        break;
                    case EventType.Unk114:
                        result = new Unk114(startTime, endTime, br);
                        break;
                    case EventType.Unk115:
                        result = new Unk115(startTime, endTime, br);
                        break;
                    case EventType.Unk116:
                        result = new Unk116(startTime, endTime, br);
                        break;
                    case EventType.Unk117:
                        result = new Unk117(startTime, endTime, br);
                        break;
                    case EventType.Unk118:
                        result = new Unk118(startTime, endTime, br);
                        break;
                    case EventType.Unk119:
                        result = new Unk119(startTime, endTime, br);
                        break;
                    case EventType.Unk120:
                        result = new Unk120(startTime, endTime, br);
                        break;
                    case EventType.Unk121:
                        result = new Unk121(startTime, endTime, br);
                        break;
                    case EventType.PlaySound1:
                        result = new PlaySound1(startTime, endTime, br);
                        break;
                    case EventType.PlaySound2:
                        result = new PlaySound2(startTime, endTime, br);
                        break;
                    case EventType.PlaySound3:
                        result = new PlaySound3(startTime, endTime, br);
                        break;
                    case EventType.PlaySound4:
                        result = new PlaySound4(startTime, endTime, br);
                        break;
                    case EventType.PlaySound5:
                        result = new PlaySound5(startTime, endTime, br);
                        break;
                    case EventType.Unk137:
                        result = new Unk137(startTime, endTime, br);
                        break;
                    case EventType.CreateDecal:
                        result = new CreateDecal(startTime, endTime, br);
                        break;
                    case EventType.Unk144:
                        result = new Unk144(startTime, endTime, br);
                        break;
                    case EventType.Unk145:
                        result = new Unk145(startTime, endTime, br);
                        break;
                    case EventType.Unk150:
                        result = new Unk150(startTime, endTime, br);
                        break;
                    case EventType.Unk151:
                        result = new Unk151(startTime, endTime, br);
                        break;
                    case EventType.Unk161:
                        result = new Unk161(startTime, endTime, br);
                        break;
                    case EventType.FadeOut:
                        result = new FadeOut(startTime, endTime, br);
                        break;
                    case EventType.Unk194:
                        result = new Unk194(startTime, endTime, br);
                        break;
                    case EventType.Unk224:
                        result = new Unk224(startTime, endTime, br);
                        break;
                    case EventType.DisableStaminaRegen:
                        result = new DisableStaminaRegen(startTime, endTime, br);
                        break;
                    case EventType.Unk226:
                        result = new Unk226(startTime, endTime, br);
                        break;
                    case EventType.Unk227:
                        result = new Unk227(startTime, endTime, br);
                        break;
                    case EventType.RagdollReviveTime:
                        result = new RagdollReviveTime(startTime, endTime, br);
                        break;
                    case EventType.Unk229:
                        result = new Unk229(startTime, endTime, br);
                        break;
                    case EventType.SetEventMessageID:
                        result = new SetEventMessageID(startTime, endTime, br);
                        break;
                    case EventType.Unk232:
                        result = new Unk232(startTime, endTime, br);
                        break;
                    case EventType.ChangeDrawMask:
                        result = new ChangeDrawMask(startTime, endTime, br);
                        break;
                    case EventType.RollDistanceReduction:
                        result = new RollDistanceReduction(startTime, endTime, br);
                        break;
                    case EventType.CreateAISound:
                        result = new CreateAISound(startTime, endTime, br);
                        break;
                    case EventType.Unk300:
                        result = new Unk300(startTime, endTime, br);
                        break;
                    case EventType.Unk301:
                        result = new Unk301(startTime, endTime, br);
                        break;
                    case EventType.AddSpEffectDragonForm:
                        result = new AddSpEffectDragonForm(startTime, endTime, br);
                        break;
                    case EventType.PlayAnimation:
                        result = new PlayAnimation(startTime, endTime, br);
                        break;
                    case EventType.BehaviorThing:
                        result = new BehaviorThing(startTime, endTime, br);
                        break;
                    case EventType.CreateBehaviorPC:
                        result = new CreateBehaviorPC(startTime, endTime, br);
                        break;
                    case EventType.Unk308:
                        result = new Unk308(startTime, endTime, br);
                        break;
                    case EventType.Unk310:
                        result = new Unk310(startTime, endTime, br);
                        break;
                    case EventType.Unk311:
                        result = new Unk311(startTime, endTime, br);
                        break;
                    case EventType.Unk312:
                        result = new Unk312(startTime, endTime, br);
                        break;
                    case EventType.Unk320:
                        result = new Unk320(startTime, endTime, br);
                        break;
                    case EventType.Unk330:
                        result = new Unk330(startTime, endTime, br);
                        break;
                    case EventType.EffectDuringThrow:
                        result = new EffectDuringThrow(startTime, endTime, br);
                        break;
                    case EventType.Unk332:
                        result = new Unk332(startTime, endTime, br);
                        break;
                    case EventType.CreateSpEffect:
                        result = new CreateSpEffect(startTime, endTime, br);
                        break;
                    case EventType.Unk500:
                        result = new Unk500(startTime, endTime, br);
                        break;
                    case EventType.Unk510:
                        result = new Unk510(startTime, endTime, br);
                        break;
                    case EventType.Unk520:
                        result = new Unk520(startTime, endTime, br);
                        break;
                    case EventType.KingOfTheStorm:
                        result = new KingOfTheStorm(startTime, endTime, br);
                        break;
                    case EventType.Unk600:
                        result = new Unk600(startTime, endTime, br);
                        break;
                    case EventType.Unk601:
                        result = new Unk601(startTime, endTime, br);
                        break;
                    case EventType.DebugAnimSpeed:
                        result = new DebugAnimSpeed(startTime, endTime, br);
                        break;
                    case EventType.Unk605:
                        result = new Unk605(startTime, endTime, br);
                        break;
                    case EventType.Unk606:
                        result = new Unk606(startTime, endTime, br);
                        break;
                    case EventType.Unk700:
                        result = new Unk700(startTime, endTime, br);
                        break;
                    case EventType.EnableTurningDirection:
                        result = new EnableTurningDirection(startTime, endTime, br);
                        break;
                    case EventType.FacingAngleCorrection:
                        result = new FacingAngleCorrection(startTime, endTime, br);
                        break;
                    case EventType.Unk707:
                        result = new Unk707(startTime, endTime, br);
                        break;
                    case EventType.HideWeapon:
                        result = new HideWeapon(startTime, endTime, br);
                        break;
                    case EventType.HideModelMask:
                        result = new HideModelMask(startTime, endTime, br);
                        break;
                    case EventType.DamageLevelModule:
                        result = new DamageLevelModule(startTime, endTime, br);
                        break;
                    case EventType.ModelMask:
                        result = new ModelMask(startTime, endTime, br);
                        break;
                    case EventType.DamageLevelFunction:
                        result = new DamageLevelFunction(startTime, endTime, br);
                        break;
                    case EventType.Unk715:
                        result = new Unk715(startTime, endTime, br);
                        break;
                    case EventType.CultStart:
                        result = new CultStart(startTime, endTime, br);
                        break;
                    case EventType.Unk730:
                        result = new Unk730(startTime, endTime, br);
                        break;
                    case EventType.Unk740:
                        result = new Unk740(startTime, endTime, br);
                        break;
                    case EventType.IFrameState:
                        result = new IFrameState(startTime, endTime, br);
                        break;
                    case EventType.BonePos:
                        result = new BonePos(startTime, endTime, br);
                        break;
                    case EventType.BoneFixOn1:
                        result = new BoneFixOn1(startTime, endTime, br);
                        break;
                    case EventType.BoneFixOn2:
                        result = new BoneFixOn2(startTime, endTime, br);
                        break;
                    case EventType.TurnLowerBody:
                        result = new TurnLowerBody(startTime, endTime, br);
                        break;
                    case EventType.Unk782:
                        result = new Unk782(startTime, endTime, br);
                        break;
                    case EventType.SpawnBulletByCultSacrifice1:
                        result = new SpawnBulletByCultSacrifice1(startTime, endTime, br);
                        break;
                    case EventType.Unk786:
                        result = new Unk786(startTime, endTime, br);
                        break;
                    case EventType.Unk790:
                        result = new Unk790(startTime, endTime, br);
                        break;
                    case EventType.Unk791:
                        result = new Unk791(startTime, endTime, br);
                        break;
                    case EventType.HitEffect2:
                        result = new HitEffect2(startTime, endTime, br);
                        break;
                    case EventType.CultSacrifice1:
                        result = new CultSacrifice1(startTime, endTime, br);
                        break;
                    case EventType.SacrificeEmpty:
                        result = new SacrificeEmpty(startTime, endTime, br);
                        break;
                    case EventType.Toughness:
                        result = new Toughness(startTime, endTime, br);
                        break;
                    case EventType.BringCultMenu:
                        result = new BringCultMenu(startTime, endTime, br);
                        break;
                    case EventType.CeremonyParamID:
                        result = new CeremonyParamID(startTime, endTime, br);
                        break;
                    case EventType.CultSingle:
                        result = new CultSingle(startTime, endTime, br);
                        break;
                    case EventType.CultEmpty2:
                        result = new CultEmpty2(startTime, endTime, br);
                        break;
                    case EventType.Unk800:
                        result = new Unk800(startTime, endTime, br);
                        break;
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        ...
        public class Unk001 : Event // 001
        {
            ...
            public Unk001(float startTime, float endTime, int unk00, int unk04, int condition, byte unk0C, byte unk0D,
                short stateInfo) : base(startTime, endTime)
            {
                Unk00 = unk00;
                Unk04 = unk04;
                Condition = condition;
        ...
        public class EnableTurningDirection : Event // 703
        {
            ...
            internal EnableTurningDirection(float startTime, float endTime, BinaryReaderEx br) : base(startTime,
                endTime)
            {
                State = br.ReadByte();
                br.AssertByte(0);
        ...
        public class SpawnBulletByCultSacrifice1 : Event // 785
        {
            ...
            internal SpawnBulletByCultSacrifice1(float startTime, float endTime, BinaryReaderEx br) : base(startTime,
                endTime)
            {
                Unk00 = br.ReadSingle();
                DummyPointID = br.ReadInt32();
        ...
        public class Toughness : Event // 795
        {
            ...
            public Toughness(float startTime, float endTime, byte toughnessParamID, bool isToughnessEffective,
                float toughnessRate) : base(startTime, endTime)
            {
