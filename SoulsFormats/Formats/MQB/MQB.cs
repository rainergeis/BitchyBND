...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    ...
    protected override void Read(BinaryReaderEx br)
    {
        ...
        br.AssertByte(0);
        var longFormat = br.AssertSByte(0, -1);
        br.AssertByte(0);
        ...
        var resourcePathsOffset = br.ReadVarint();
        ...
        var resourceCount = br.ReadInt32();
        var cutCount = br.ReadInt32();
        var unkX50 = br.ReadInt32();
        br.AssertInt32(0);
        br.AssertInt32(0);
        br.AssertInt32(0);
        br.AssertInt32(0);
        ...
        var resourcePathOffsets = br.ReadVarints(resourceCount);
        ResourceDirectory = br.ReadUTF16();
        for (var i = 0; i < resourceCount; i++)
        {
            var offset = resourcePathOffsets[i];
            if (offset != 0)
    ...
    protected override void Write(BinaryWriterEx bw)
    {
        ...
        switch (Version)
        {
            case MQBVersion.DarkSouls2:
                bw.WriteInt32(0x14);
                break;
            case MQBVersion.DarkSouls2Scholar:
                bw.WriteInt32(0x28);
                break;
            case MQBVersion.Bloodborne:
                bw.WriteInt32(0x20);
                break;
            case MQBVersion.DarkSouls3:
                bw.WriteInt32(0x24);
                break;
            default:
        ...
        for (var i = 0; i < allCustomData.Count; i++)
