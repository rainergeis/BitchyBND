...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    ...
    protected override void Read(BinaryReaderEx br)
    {
        ...
        var countA = br.ReadInt32();
        var countB = br.ReadInt32();
        var countC = br.ReadInt32();
        var countD = br.ReadInt32();
        Unk1C = br.ReadInt32();

        br.VarintLong = Version == NGPVersion.Scholar;
        var offsetA = br.ReadVarint();
        var offsetB = br.ReadVarint();
        var offsetC = br.ReadVarint();
        var offsetD = br.ReadVarint();
        var meshOffsets = br.ReadVarints(meshCount);
    ...
    public class Mesh
    {
        ...
        internal Mesh(BinaryReaderEx br, NGPVersion version)
        {
            ...
            var faceCount = br.ReadInt16();
            var count30 = br.ReadInt16();
            Unk30 = br.ReadInt16();
            Unk32 = br.ReadInt16();
            br.AssertByte(1);
            br.AssertByte(0);
            ...
            if (version == NGPVersion.Scholar)
                br.AssertInt64(0);
            var verticesOffset = br.ReadVarint();
            var offset48 = br.ReadVarint();
            var facesOffset = br.ReadVarint();
            var offset58 = br.ReadVarint();
            var offset60 = br.ReadVarint();
            var offset68 = br.ReadVarint();
        ...
        internal void Write(BinaryWriterEx bw, NGPVersion version)
        {
            ...
            foreach (var struct2 in Struct2s)
    ...
    public class Struct5
    {
        ...
        {
            Unk00 = br.ReadSingle();
            var leftIndex = br.ReadInt16();
            var rightIndex = br.ReadInt16();
            var faceIndexCount = br.ReadInt16();
            var faceIndexIndex = br.ReadInt16();
