...
public class BTPB : SoulsFile<BTPB>
{
    ...
    {
        var bigEndian = br.BigEndian = br.GetBoolean(0x10);

        var unk00 = br.AssertInt32(2, 3);
        var unk04 = br.AssertInt32(0, 1);
        var groupCount = br.ReadInt32();
        var dataLength = br.ReadInt32();
        br.AssertBoolean(bigEndian);
        br.AssertPattern(3, 0x00);
        var groupSize = br.AssertInt32(0x40, 0x48, 0x98);
        var probeSize = br.AssertInt32(0x1C, 0x48);
        ...
        if (!bigEndian && unk00 == 2 && unk04 == 1 && groupSize == 0x40 && probeSize == 0x1C)
            ...
            throw new InvalidDataException(
                $"Unknown BTPB format. {nameof(bigEndian)}:{bigEndian} {nameof(unk00)}:0x{unk00:X}" +
    ...
    protected override void Write(BinaryWriterEx bw)
    {
        ...
        var nameOffsets = new long[Groups.Count];
        var probesOffsets = new long[Groups.Count];
    ...
    public class Group
    {
        ...
        {
            var nameOffset = br.ReadVarint();
            Flags08 = br.ReadInt32();
            var probeCount = br.ReadInt32();
            Unk10 = br.ReadInt32();
            Unk14 = br.ReadInt32();
            Unk18 = br.ReadInt32();
            Unk1C = br.ReadSingle();
            ...
            var probesOffset = br.ReadVarint();
