...
public class BTAB : SoulsFile<BTAB>
{
    ...
    protected override void Write(BinaryWriterEx bw)
    {
        ...
        {
            var partNameOffset = bw.Position - stringsStart;
            ...
            var materialNameOffset = bw.Position - stringsStart;
    ...
    public class Entry
    {
        ...
        {
            var msbNameOffset = br.ReadVarint();
            var flverNameOffset = br.ReadVarint();
