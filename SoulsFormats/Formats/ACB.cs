...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
    ...
    protected override void Read(BinaryReaderEx br)
    {
        ...
        foreach (var assetOffset in br.ReadInt32s(assetCount))
        {
    ...
    protected override void Write(BinaryWriterEx bw)
    {
        ...
        for (var i = 0; i < Assets.Count; i++) Assets[i].WritePaths(bw, i);
    ...
    public abstract class Asset
    {
        ...
        {
            var absolutePathOffset = br.ReadInt32();
            var relativePathOffset = br.ReadInt32();
        ...
        internal virtual void Write(BinaryWriterEx bw, int index, List<int> offsetIndex,
        ...
        public class PWV : Asset
        {
            ...
            internal override void Write(BinaryWriterEx bw, int index, List<int> offsetIndex,
                SortedDictionary<int, List<int>> membersOffsetIndex)
            {
        ...
        public class Model : Asset
        {
            ...
            {
                Unk0A = br.ReadInt16();
                var membersOffset = br.ReadInt32();
            ...
            internal void WriteMembers(BinaryWriterEx bw, int index, List<int> offsetIndex,
                SortedDictionary<int, List<int>> membersOffsetIndex)
            {
                if (Members == null)
                {
            ...
            public class MemberList : List<Member>
            {
                ...
                internal MemberList(BinaryReaderEx br)
                {
                    ...
                    var memberOffsetsOffset = br.ReadInt32();

                    br.StepIn(memberOffsetsOffset);
                    {
                        Capacity = memberCount;
                        var memberOffsets = br.ReadInt32s(memberCount);
                ...
                internal void Write(BinaryWriterEx bw, int index, List<int> offsetIndex,
                    SortedDictionary<int, List<int>> membersOffsetIndex)
                {
                    bw.WriteInt16(Unk00);
