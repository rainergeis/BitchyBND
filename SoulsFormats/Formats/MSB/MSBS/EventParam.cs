...
public partial class MSBS
{
    ...
    public class EventParam : Param<Event>, IMsbParam<IMsbEvent>
    {
        ...
        /// <summary>
        ///     Indicates a shift of the entire map; already accounted for in MSB positions, but must be applied to other formats
        ///     such as BTL. Should only be one per map, if any.
        /// </summary>
        ...
        IMsbEvent IMsbParam<IMsbEvent>.Add(IMsbEvent item)
        {
            return Add((Event)item);
        }

        IReadOnlyList<IMsbEvent> IMsbParam<IMsbEvent>.GetEntries()
        {
            return GetEntries();
        }
        ...
        public Event Add(Event evnt)
        {
            switch (evnt)
            {
                ...
                case Event.PlatoonInfo e:
                    PlatoonInfo.Add(e);
                    break;
                case Event.ResourceItemInfo e:
                    ResourceItemInfo.Add(e);
                    break;
                case Event.GrassLodParam e:
                    GrassLodParams.Add(e);
                    break;
                case Event.SkitInfo e:
                    SkitInfo.Add(e);
                    break;
                case Event.PlacementGroup e:
                    PlacementGroups.Add(e);
                    break;
                case Event.PartsGroup e:
                    PartsGroups.Add(e);
                    break;
                case Event.Talk e:
                    Talks.Add(e);
                    break;
                case Event.AutoDrawGroupCollision e:
                    AutoDrawGroupCollisions.Add(e);
                    break;
                case Event.Other e:
                    Others.Add(e);
                    break;
    ...
    public abstract class Event : Entry, IMsbEvent
    {
        ...
        private protected Event(BinaryReaderEx br)
        {
            ...
            br.ReadInt32(); // ID
            br.AssertInt32(0);
            var baseDataOffset = br.ReadInt64();
        ...
        public class PatrolInfo : Event
        {
            ...
            private protected override void DeepCopyTo(Event evnt)
            {
                ...
                for (var i = 0; i < WREntries.Length; i++)
            ...
            internal override void GetNames(MSBS msb, Entries entries)
            {
                ...
                for (var i = 0; i < WalkRegionIndices.Length; i++)
            ...
            internal override void GetIndices(MSBS msb, Entries entries)
            {
                ...
                for (var i = 0; i < WalkRegionNames.Length; i++)
