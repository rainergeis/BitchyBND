...
public partial class MSBS
{
        ...
        public Region Add(Region region)
        {
            switch (region)
            {
                ...
                case Region.MufflingPortal r:
                    ...
                    break;
                case Region.SoundSpaceOverride r:
                    SoundSpaceOverrides.Add(r);
                    break;
                case Region.MufflingPlane r:
                    MufflingPlanes.Add(r);
                    break;
                case Region.PartsGroupArea r:
                    PartsGroupAreas.Add(r);
                    break;
    ...
    public abstract class Region : Entry, IMsbRegion
    {
        ...
        internal override void Write(BinaryWriterEx bw, int id)
        {
            ...
            if (HasTypeData)
            {
                if (Type == RegionType.SoundSpaceOverride || Type == RegionType.PartsGroupArea ||
                    Type == RegionType.AutoDrawGroupPoint)
                    bw.Pad(8);
