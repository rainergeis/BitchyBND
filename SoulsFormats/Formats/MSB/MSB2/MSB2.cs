...
public partial class MSB2 : SoulsFile<MSB2>, IMsb
{
    ...
    protected override bool Is(BinaryReaderEx br)
    {
        ...
        var modelVersion = br.GetInt32(0x10);
    ...
    protected override void Read(BinaryReaderEx br)
    {
        ...
        if (br.Position != 0)
            throw new InvalidDataException(
                $"The next param offset of the final param should be 0, but it was 0x{br.Position:X}.");
    ...
    public abstract class Param<T> where T : Entry
    {
        ...
        internal List<T> Read(BinaryReaderEx br)
        {
            ...
            var entryOffsets = br.ReadVarints(offsetCount - 1);
            var nextParamOffset = br.ReadVarint();

            var name = br.GetUTF16(nameOffset);
            if (name != Name)
