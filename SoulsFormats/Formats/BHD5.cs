...
public class BHD5
{
    ...
    private BHD5(BinaryReaderEx br, Game game)
    {
        ...
        var bucketCount = br.ReadInt32();
        var bucketsOffset = br.ReadInt32();
    ...
    public class Bucket : List<FileHeader>
    {
        ...
        internal Bucket(BinaryReaderEx br, Game game)
        {
            var fileHeaderCount = br.ReadInt32();
            var fileHeadersOffset = br.ReadInt32();
            Capacity = fileHeaderCount;

            br.StepIn(fileHeadersOffset);
            {
                for (var i = 0; i < fileHeaderCount; i++)
    ...
    public class FileHeader
    {
        ...
        internal FileHeader(BinaryReaderEx br, Game game)
        {
            ...
            else
            {
                ...
                if (game >= Game.DarkSouls3) UnpaddedFileSize = br.ReadInt64();
            }
        ...
        internal void Write(BinaryWriterEx bw, Game game, int bucketIndex, int fileIndex)
        {
            ...
            else
            {
                ...
                if (game >= Game.DarkSouls3) bw.WriteInt64(UnpaddedFileSize);
            }
        }
        ...
        {
            var bytes = new byte[PaddedFileSize];
    ...
    public class AESKey
    {
        private static readonly AesManaged AES = new()
            { Mode = CipherMode.ECB, Padding = PaddingMode.None, KeySize = 128 };
        ...
        public void Decrypt(byte[] bytes)
        {
            ...
            {
                foreach (Range range in Ranges.Where(r =>
                             r.StartOffset != -1 && r.EndOffset != -1 && r.StartOffset != r.EndOffset))
                {
                    var start = (int)range.StartOffset;
                    var count = (int)(range.EndOffset - range.StartOffset);
