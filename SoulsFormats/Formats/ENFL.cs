...
/// <summary>
///     A mysterious file format used in BB and DS3. Speculation: determines assets to load based on location in a map.
...
public class ENFL : SoulsFile<ENFL>
{
    ...
    protected override void Read(BinaryReaderEx br)
    {
        ...
        var data = SFUtil.ReadZlib(br, compressedSize);

        br = new BinaryReaderEx(false, data);
        br.AssertInt32(0);
        var unkCount1 = br.ReadInt32();
        var unkCount2 = br.ReadInt32();
        br.AssertInt32(0);
    ...
    public class Struct1
    {
        ...
        /// <summary>
        ///     Increase of index to next Struct1. For instance, if Step is 0, the next Struct1 will have the same index. If Step
        ///     is 2, the next Struct will have this Index + 2.
        /// </summary>
        public short Step;
