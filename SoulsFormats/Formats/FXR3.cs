...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    ...
    protected override void Read(BinaryReaderEx br)
    {
        ...
        br.AssertInt32(1);
        ID = br.ReadInt32();
        var section1Offset = br.ReadInt32();
        ...
        var section4Offset = br.ReadInt32();
    ...
    protected override void Write(BinaryWriterEx bw)
    {
        ...
        for (var i = 0; i < section2s.Count; i++)
        ...
        var section5Count = 0;
        for (var i = 0; i < section4s.Count; i++)
        ...
        for (var i = 0; i < section6s.Count; i++)
        ...
        for (var i = 0; i < section7s.Count; i++)
        ...
        for (var i = 0; i < section8s.Count; i++)
        ...
        var section11Count = 0;
        for (var i = 0; i < section3s.Count; i++)
        ...
        for (var i = 0; i < section9s.Count; i++)
            section9s[i].WriteSection11s(bw, i, ref section11Count);
        for (var i = 0; i < section10s.Count; i++)
    ...
    public class Section1
    {
        ...
        {
            br.AssertInt32(0);
            var section2Count = br.ReadInt32();
            var section2Offset = br.ReadInt32();
            br.AssertInt32(0);
    ...
    public class Section2
    {
        ...
        {
            br.AssertInt32(0);
            var section3Count = br.ReadInt32();
            var section3Offset = br.ReadInt32();
            br.AssertInt32(0);
    ...
    public class Section3
    {
        ...
        internal Section3(BinaryReaderEx br)
        {
            ...
            br.AssertInt32(1);
            br.AssertInt32(0);
            var section11Offset1 = br.ReadInt32();
            br.AssertInt32(0);
            br.AssertInt32(0);
            br.AssertInt32(0);
            br.AssertInt32(0);
            ...
            br.AssertInt32(1);
            br.AssertInt32(0);
            var section11Offset2 = br.ReadInt32();
            br.AssertInt32(0);
            br.AssertInt32(0);
            br.AssertInt32(0);
            br.AssertInt32(0);
    ...
    public class Section4
    {
        ...
        internal Section4(BinaryReaderEx br)
        {
            ...
            br.AssertByte(1);
            br.AssertInt32(0);
            var section5Count = br.ReadInt32();
            var section6Count = br.ReadInt32();
            var section4Count = br.ReadInt32();
            br.AssertInt32(0);
            var section5Offset = br.ReadInt32();
            br.AssertInt32(0);
            var section6Offset = br.ReadInt32();
            br.AssertInt32(0);
            var section4Offset = br.ReadInt32();
            br.AssertInt32(0);
        ...
        {
            var index = section4s.IndexOf(this);
        ...
        internal void WriteSection5s(BinaryWriterEx bw, int index, ref int section5Count)
        {
            ...
            else
            {
                ...
                for (var i = 0; i < Section5s.Count; i++)
                    Section5s[i].Write(bw, section5Count + i);
                section5Count += Section5s.Count;
            }
        }

        internal void WriteSection6s(BinaryWriterEx bw, int index, ref int section5Count,
            List<FFXDrawEntityHost> section6s)
        {
    ...
    public class FFXDrawEntityHost
    {
        ...
        internal FFXDrawEntityHost(BinaryReaderEx br)
        {
            ...
            Unk04 = br.ReadInt32();
            var section11Count1 = br.ReadInt32();
            var section10Count = br.ReadInt32();
            var section7Count1 = br.ReadInt32();
            var section11Count2 = br.ReadInt32();
            br.AssertInt32(0);
            var section7Count2 = br.ReadInt32();
            var section11Offset = br.ReadInt32();
            br.AssertInt32(0);
            var section10Offset = br.ReadInt32();
            br.AssertInt32(0);
            var section7Offset = br.ReadInt32();
            br.AssertInt32(0);
            br.AssertInt32(0);
            br.AssertInt32(0);
    ...
    public class FFXProperty
    {
        ...
        internal FFXProperty(BinaryReaderEx br)
        {
            ...
            br.AssertByte(1);
            Unk04 = br.ReadInt32();
            var section11Count = br.ReadInt32();
            br.AssertInt32(0);
            var section11Offset = br.ReadInt32();
            br.AssertInt32(0);
            var section8Offset = br.ReadInt32();
            br.AssertInt32(0);
            var section8Count = br.ReadInt32();
            br.AssertInt32(0);
    ...
    public class Section8
    {
        ...
        internal Section8(BinaryReaderEx br)
        {
            ...
            Unk04 = br.ReadInt32();
            var section11Count = br.ReadInt32();
            var section9Count = br.ReadInt32();
            var section11Offset = br.ReadInt32();
            br.AssertInt32(0);
            var section9Offset = br.ReadInt32();
            br.AssertInt32(0);
