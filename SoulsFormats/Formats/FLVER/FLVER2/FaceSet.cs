...
public partial class FLVER2
{
    ...
    public partial class FaceSet
    {
        ...
        internal FaceSet(BinaryReaderEx br, FLVERHeader header, int headerIndexSize, int dataOffset)
        {
            ...
            if ((indexSize == 8) ^ Flags.HasFlag(FSFlags.EdgeCompressed))
                throw new InvalidDataException(
                    "FSFlags.EdgeCompressed probably doesn't mean edge compression after all. Please investigate this.");
            ...
            else if (indexSize == 16)
            {
                ...
                foreach (var index in br.GetUInt16s(dataOffset + indicesOffset, indexCount))
                    Indices.Add(index);
            }
        ...
        /// </summary>
        /// <param name="allowPrimitiveRestarts">
        ///     Whether indices of 0xFFFF will restart the strip; use when the parent mesh has
        ///     fewer than that many vertices.
        /// </param>
