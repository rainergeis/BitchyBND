...
public partial class FLVER2
{
    ...
    public class Material : IFlverMaterial
    {
        ...
        internal Material(BinaryReaderEx br, FLVERHeader header, List<GXList> gxLists,
        ...
        internal void TakeTextures(Dictionary<int, Texture> textureDict)
        {
            ...
            for (var i = textureIndex; i < textureIndex + textureCount; i++)
            {
